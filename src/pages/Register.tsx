      ...
      <div className="flex-1 flex items-center justify-center p-8 mesh-bg relative overflow-y-auto">
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-md">
          ...
          <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} className="mt-8">
            <Button variant="outline" className="w-full h-12 rounded-xl glass-subtle border-border/50 text-foreground gap-3" onClick={handleGoogleSignup} disabled={loading}>
